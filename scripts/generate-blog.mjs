...
// Lead magnet CTA — injected at bottom of every blog post
const LEAD_MAGNET_CTA = `
<div style="margin:48px 0;padding:32px 28px;background:#fff8f2;border:2px solid #FF7A00;border-radius:12px;text-align:center;">
  <p style="font-size:0.8rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#FF7A00;margin-bottom:10px;">FREE DOWNLOAD</p>
  <h3 style="font-size:1.3rem;font-weight:700;color:#1a1a1a;margin-bottom:10px;">10 Questions to Record Your Child Saying This Week</h3>
  <p style="color:#555;font-size:0.95rem;margin-bottom:22px;">Before their voice changes — and it will. Takes 5 minutes. You'll be glad you did it.</p>
  <a href="/free-guide" style="display:inline-block;background:#FF7A00;color:#fff;font-weight:700;padding:14px 32px;border-radius:8px;text-decoration:none;font-size:1rem;">Get the free guide &#x2192;</a>
</div>`;
